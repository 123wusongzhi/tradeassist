...
if (!/^p7v2-baseline-r3b-recovery-[a-z0-9_-]+$/.test(runId)) {
  throw new Error('P7-V2-R3B-REBASELINE requires a unique recovery baseline run ID');
}
...
try {
  ...
  const registry = readJSON(registryPath) || { phase: 'P7-V2-R3B-REBASELINE', baselines: [] };
  ...
  registry.phase = 'P7-V2-R3B-REBASELINE';

...
export function revalidateRuntimeFreeze({ writeReport = false, mode = 'revalidate' } = {}) {
  ...
  const checks = [
    ...
    compare('lifecycleContractHash', stored.lifecycleContractHash, rebuilt.lifecycleContractHash),
    compare('databasePostDatasetBarrierHash', stored.databasePostDatasetBarrierHash, rebuilt.databasePostDatasetBarrierHash),
    compare('warmupManifestHash', stored.warmupManifestHash, rebuilt.warmupManifestHash),
    compare('cooldownContractHash', stored.cooldownContractHash, rebuilt.cooldownContractHash),
    compare('hostQuietWindowContractHash', stored.hostQuietWindowContractHash, rebuilt.hostQuietWindowContractHash),
    compare('postgresIsolationContractHash', stored.postgresIsolationContractHash, rebuilt.postgresIsolationContractHash),
    compare('evidenceWriterContractHash', stored.evidenceWriterContractHash, rebuilt.evidenceWriterContractHash),
    compare('hostIsolationContractHash', stored.hostIsolationContractHash, rebuilt.hostIsolationContractHash),
  ...
  const report = {
    ...
    hostIsolationBindingPassed: Boolean(stored.hostIsolationContractHash && rebuilt.hostIsolationContractHash && stored.hostIsolationContractHash === rebuilt.hostIsolationContractHash),
    warmupBindingPassed: Boolean(stored.warmupManifestHash && rebuilt.warmupManifestHash && stored.warmupManifestHash === rebuilt.warmupManifestHash),
    quietWindowBindingPassed: Boolean(stored.hostQuietWindowContractHash && rebuilt.hostQuietWindowContractHash && stored.hostQuietWindowContractHash === rebuilt.hostQuietWindowContractHash),
    postgresIsolationBindingPassed: Boolean(stored.postgresIsolationContractHash && rebuilt.postgresIsolationContractHash && stored.postgresIsolationContractHash === rebuilt.postgresIsolationContractHash),

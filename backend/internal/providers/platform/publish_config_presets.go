...
func amazonPublishSchema() PlatformAppConfigSchema {
	return PlatformAppConfigSchema{
		...
		Fields: []AppConfigField{
			...
			{Name: "brand", Label: "Brand", Type: "text", Required: true, Sensitive: false},
			{Name: "manufacturer", Label: "Manufacturer", Type: "text", Required: true, Sensitive: false},
			{Name: "default_weight", Label: "默认重量", Type: "text", Required: false, Sensitive: false},
			{Name: "weight_unit", Label: "重量单位（平台字段值）", Type: "text", Required: false, Sensitive: false, Help: "仅在填写默认重量时使用；按 Product Type Definitions 要求填写。"},
			{Name: "default_length", Label: "默认长度", Type: "text", Required: false, Sensitive: false},
			{Name: "default_width", Label: "默认宽度", Type: "text", Required: false, Sensitive: false},
			{Name: "default_height", Label: "默认高度", Type: "text", Required: false, Sensitive: false},
			{Name: "dimension_unit", Label: "尺寸单位（平台字段值）", Type: "text", Required: false, Sensitive: false, Help: "仅在填写默认长宽高时使用；按 Product Type Definitions 要求填写。"},
			{Name: "issue_locale", Label: "Issue Locale（可选）", Type: "text", Required: false, Sensitive: false},
...
func ozonPublishSchema() PlatformAppConfigSchema {
	return PlatformAppConfigSchema{
		...
		Fields: []AppConfigField{
			...
			{Name: "default_weight", Label: "默认重量（克）", Type: "number", Required: true, Sensitive: false, Placeholder: "例如 500", Help: "Ozon /v3/product/import 必填；必须大于 0，单位为克。"},
			{Name: "default_width", Label: "默认宽度（毫米）", Type: "number", Required: true, Sensitive: false, Placeholder: "例如 150", Help: "Ozon /v3/product/import 必填；必须大于 0，单位为毫米。"},
			{Name: "default_height", Label: "默认高度（毫米）", Type: "number", Required: true, Sensitive: false, Placeholder: "例如 100", Help: "Ozon /v3/product/import 必填；必须大于 0，单位为毫米。"},
			{Name: "default_depth", Label: "默认深度（毫米）", Type: "number", Required: true, Sensitive: false, Placeholder: "例如 200", Help: "Ozon /v3/product/import 必填；必须大于 0，单位为毫米。"},
			...
			{Name: "auto_fill_attributes", Label: "自动匹配类目属性", Type: "switch", Required: false, Sensitive: false, DefaultValue: true, Help: "开启后按商品参数/默认值自动补充属性；关闭后仅使用商品级明确保存的属性，缺少必填项会阻止提交。"},
			{Name: "ai_auto_fill", Label: "AI 自动补全缺失必填属性", Type: "switch", Required: false, Sensitive: false, DefaultValue: true, Help: "规则匹配后仍有缺失项时生成建议并严格匹配 Ozon 词典；AI 不可用或仍缺少必填项时会阻止提交。"},
		},
	}
}

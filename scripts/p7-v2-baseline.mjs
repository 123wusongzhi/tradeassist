...
if (!/^p7v2-baseline-r3b-recovery4-[a-z0-9_-]+$/.test(runId)) {
  throw new Error('P7-V2-R3B-FAST-CLOSE requires a unique Recovery4 baseline run ID');
}
...
try {
  ...
  const registry = readJSON(registryPath) || { phase: 'P7-V2-R3B-FAST-CLOSE', baselines: [] };
  ...
  registry.phase = 'P7-V2-R3B-FAST-CLOSE';
  ...
  console.log(JSON.stringify({ phase: 'P7-V2-R3B-FAST-CLOSE', kind: 'baseline', runId, freeze: 'passed', sha256: frozen.sha256 }, null, 2));
} catch (error) {

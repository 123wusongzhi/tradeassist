...
| [P6_BACKUP_RELEASE_DR_AUDIT.md](P6_BACKUP_RELEASE_DR_AUDIT.md) / [P6_BACKUP_RELEASE_DR_REPORT.md](P6_BACKUP_RELEASE_DR_REPORT.md) | P6 备份、恢复、发布、回滚与灾备代码级基础；隔离演练、Linux Race、真实生产验证仍按报告 Deferred / Incomplete | 后端 / 运维 / AI Agent |

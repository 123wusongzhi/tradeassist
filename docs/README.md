...
| 我想本地跑起来或用 Docker 试用 | [development.md](development.md) · [docker-deployment.md](docker-deployment.md) · [collector-engines.md](collector-engines.md) · [env.md](env.md) |
...
| [windows-environment.md](windows-environment.md) | Windows 系统环境摩擦审计、已验证状态与处理清单 | 开发者 / AI Agent |
...
| [collector-engines.md](collector-engines.md) | Playwright `3001`、OpenCLI Bridge `3100`、按任务路由、部署矩阵与验收 |
...
| [collector-engines.md](collector-engines.md) | Collector Engine 支持范围、运行边界和故障隔离 |

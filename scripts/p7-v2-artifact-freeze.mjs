...
export function freezeRawArtifact({ kind, runId, reportPath }) {
  ...
  try {
    ...
    const manifest = {
      ...
      formalBinaryProvenanceVersion: report.formalBinaryProvenanceVersion || null,
      binarySha256: report.serverBinarySha256 || report.binarySha256 || '',
      expectedBinarySha256: report.expectedBinarySha256 || '',
      processExecutableSha256: report.processExecutableSha256 || '',
      processExecutableSha256Match: report.processExecutableSha256Match ?? null,
      formalInputSequenceBindingVersion: report.formalInputSequenceBindingVersion || null,
      inputSequenceManifestHash: report.inputSequenceManifestHash || '',
      requestSequenceHash: report.requestSequenceHash || '',
      webhookSequenceHash: report.webhookSequenceHash || '',
      authSequenceHash: report.authSequenceHash || '',
      webhookDuplicateSequenceHash: report.webhookDuplicateSequenceHash || '',
      webhookBranchMixFingerprint: report.webhookBranchMixFingerprint || '',
      authBranchMixFingerprint: report.authBranchMixFingerprint || '',
      branchMixFingerprint: report.branchMixFingerprint || '',
      webhookBranchMix: report.webhookBranchMix || {},
      authBranchMix: report.authBranchMix || {},

...
| [P7_C_CAPABILITY_CLOSURE_AUDIT.md](P7_C_CAPABILITY_CLOSURE_AUDIT.md) / [P7_C_CAPABILITY_CLOSURE_REPORT.md](P7_C_CAPABILITY_CLOSURE_REPORT.md) / [P7_C_CACHE_DECISION.md](P7_C_CACHE_DECISION.md) / [P7_C_RACE_PACKAGE_MAPPING.md](P7_C_RACE_PACKAGE_MAPPING.md) | P7-C 性能能力补齐与运行验证前置收口；当前已补 Cursor 签名、cache 包、resume/race/gate 入口，但 Medium 运行验证和 Linux Race 仍 blocked | 后端 / 运维 / AI Agent |

...
> Current status: **Post-F9 Enhancement** · **MVP Demo Ready** (final acceptance completed on 2026-07-07). **F1–F9 done** · **Tag deferred**. The project is still **not Production Ready** and gray release is not allowed; real Douyin E2E remains blocked by real credentials, so Douyin Shop stays **Release Candidate**. **H1.5** secondary list URL state and browser sign-off; **H1.4** order/exception URL state and keyword UX; H1.3 AI image warning convergence — [`docs/POST_F9_ENHANCEMENT_PLAN.md`](docs/POST_F9_ENHANCEMENT_PLAN.md), [`docs/H1_5_SECONDARY_URL_BROWSER_CHECK.md`](docs/H1_5_SECONDARY_URL_BROWSER_CHECK.md).

...
| [P7_PERFORMANCE_CAPACITY_AUDIT.md](P7_PERFORMANCE_CAPACITY_AUDIT.md) / [P7_PERFORMANCE_ARCHITECTURE.md](P7_PERFORMANCE_ARCHITECTURE.md) / [P7_PERFORMANCE_TARGETS.md](P7_PERFORMANCE_TARGETS.md) / [P7_PERFORMANCE_CAPACITY_REPORT.md](P7_PERFORMANCE_CAPACITY_REPORT.md) | P7 性能、容量、大数据量、背压与限流治理基础；P7-C4 运行验证已关闭，P7-V2 负载/Soak/回归仍待执行 | 后端 / 运维 / AI Agent |

...
| [P7_PERFORMANCE_CAPACITY_AUDIT.md](P7_PERFORMANCE_CAPACITY_AUDIT.md) / [P7_PERFORMANCE_ARCHITECTURE.md](P7_PERFORMANCE_ARCHITECTURE.md) / [P7_PERFORMANCE_TARGETS.md](P7_PERFORMANCE_TARGETS.md) / [P7_PERFORMANCE_CAPACITY_REPORT.md](P7_PERFORMANCE_CAPACITY_REPORT.md) / [P7_V2_R3B_CI_RG_FINAL_REPORT.md](P7_V2_R3B_CI_RG_FINAL_REPORT.md) / [P7_V2_R3B_LPF_FINAL_REPORT.md](P7_V2_R3B_LPF_FINAL_REPORT.md) / [P7_V2_R3B_PRR_A_FINAL_REPORT.md](P7_V2_R3B_PRR_A_FINAL_REPORT.md) / [P7_V2_R3B_FORMAL_EMPTY_RUN_ID_INVOCATION_INCIDENT.md](P7_V2_R3B_FORMAL_EMPTY_RUN_ID_INVOCATION_INCIDENT.md) / [P7_V2_R3B_FORMAL_INVOCATION_PREFLIGHT_V3_FINAL_GATE.md](P7_V2_R3B_FORMAL_INVOCATION_PREFLIGHT_V3_FINAL_GATE.md) | P7 性能、容量、R3B 进程身份/冻结证据、Load Profile 指纹、PRR-A 诊断、Formal Invocation V2 与 Preflight V3 tooling repair 入口 | 后端 / 运维 / AI Agent |
...
| [P7_V2_R3B_FORMAL_HOST_ISOLATION_REPAIR.md](P7_V2_R3B_FORMAL_HOST_ISOLATION_REPAIR.md) | Formal Host Isolation Contract V2 repair evidence, harness sub-root-cause classification, lifecycle/dataset/warmup/cooldown/quiet-window/PostgreSQL isolation binding, and guardrail non-changes. |
| [P7_V2_R3B_FORMAL_HOST_ISOLATION_FINAL_GATE.md](P7_V2_R3B_FORMAL_HOST_ISOLATION_FINAL_GATE.md) | Generated final gate for the Host Isolation Contract V2 repair; passing does not start the post-repair validation matrix or close P7-V2. |
